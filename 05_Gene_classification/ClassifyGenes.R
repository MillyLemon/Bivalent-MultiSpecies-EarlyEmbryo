...
###################################################
# experiment_MACS_file: 峰检测结果文件（bed 格式）
# 注意：变量名中的 "MACS" 仅表示历史上最初适配 MACS2 输出，
# 但本课题实际使用的是 SICER2 的 island 文件转换后的 bed 文件。
# 该参数兼容任何 bed 格式的 peak 文件。

mapped_file_dir="./"
mapped_file_names=c("/data/lixm/My_project/Analysis/mouse/paper1/ChIP_seq/picard_bam/merged_bams/merged_2_cell_H3K27me3.bam","/data/lixm/My_project/Analysis/mouse/paper1/ChIP_seq/picard_bam/merged_bams/2_cell_input_f2q30_pmd.bam")
experiment_names=c("2_cell_H3K27me3","2_cell_input")
experiment_MACS_file="/data/lixm/My_project/Analysis/mouse/paper1/ChIP_seq/sicer/mergebam_callpeak/merged_2_cell_H3K27me3-W200-G600-FDR0.01-island.bed"
dots=TRUE
max_sim_reads=1000000
library(TxDb.Mmusculus.UCSC.mm10.ensGene)
txdb_file<-TxDb.Mmusculus.UCSC.mm10.ensGene
pval_cut=.001
fc_cut=1
promoter=3000
...
pvals=exactTest(d,colnames(region_counts)[2:1],dispersion=0.05) # https://www.rdocumentation.org/packages/edgeR/versions/3.14.0/topics/exactTest
pvals=pvals$table
